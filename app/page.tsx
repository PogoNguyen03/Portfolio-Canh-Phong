...
import {
  ...
  Activity, GitCommit // Thêm icon mới
} from 'lucide-react';
import { motion, useScroll, useSpring, AnimatePresence } from 'framer-motion';

// --- COMPONENTS ---

// 1. Component Typewriter (Gõ chữ) - MỚI
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        setData(fetchedData);
        // Lấy username từ link github (ví dụ: github.com/pogonguyen03 -> pogonguyen03)
        ...
        <section id="about" className="min-h-[85vh] flex flex-col justify-center mb-20 scroll-mt-32">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              {/* MỚI: Typewriter Effect cho Role */}
          ...
          <div className="bg-white/40 dark:bg-slate-900/40 backdrop-blur-sm p-8 rounded-3xl border border-slate-200 dark:border-slate-800 overflow-hidden">
             ...
             {githubUsername ? (
                 <div className="w-full overflow-x-auto pb-2 scrollbar-hide">
                    {/* Sử dụng API ghchart để tạo ảnh SVG biểu đồ. Màu '3b82f6' là màu blue-500 */}
                    <img 
                    ...
                    <p className="text-xs text-slate-400 mt-4 text-center">
                        Data sourced from <a href={`https://github.com/${githubUsername}`} target="_blank" className="underline hover:text-blue-500">github.com/{githubUsername}</a>
                    </p>
                 </div>
             ) : (
